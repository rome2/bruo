...
////////////////////////////////////////////////////////////////////////////////
///\file    selectallaction.cpp
///\ingroup bruo
///\brief   Select all action implementation.
...
////////////////////////////////////////////////////////////////////////////////
SelectAllAction::SelectAllAction(MainFrame* parent) :
  ActiveDocumentAction(QIcon(":/images/edit-select-all.png"), tr("&Select all"), parent)
{
  setStatusTip(tr("Select the entire document"));
  setShortcuts(QKeySequence::SelectAll);
