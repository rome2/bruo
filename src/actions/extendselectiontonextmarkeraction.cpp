...
////////////////////////////////////////////////////////////////////////////////
///\file    extendselectiontonextmarkeraction.cpp
///\ingroup bruo
///\brief   Extend selection to next marker action implementation.
...
////////////////////////////////////////////////////////////////////////////////
ExtendSelectionToNextMarkerAction::ExtendSelectionToNextMarkerAction(MainFrame* parent) :
  QAction(QIcon(":/images/edit-select-to-next-marker.png"), tr("Extend to next &marker"), parent),
  m_parent(parent)
{
  setEnabled(false);
  setStatusTip(tr("Extend selection to the next marker"));
...
////////////////////////////////////////////////////////////////////////////////
void ExtendSelectionToNextMarkerAction::documentCreated(Document* doc)
{
...
////////////////////////////////////////////////////////////////////////////////
void ExtendSelectionToNextMarkerAction::selectionChanged()
{
  // Get document:
...
//////////////////////////////////////////////////////////////////////////////
void ExtendSelectionToNextMarkerAction::fired()
{
}
