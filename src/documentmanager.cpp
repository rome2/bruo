...
//////////////////////////////////////////////////////////////////////////////
void DocumentManager::cleanup()
{
  // Save recent files:
  QSettings().setValue("document/recentFiles", m_recentFiles);
}
...
////////////////////////////////////////////////////////////////////////////////
///\brief   Accessor for the recent file list of this application.
///\return  The application's recent files.
///\remarks The recent file list is unchecked. Use the filenames with caution.
////////////////////////////////////////////////////////////////////////////////
QStringList& DocumentManager::recentFiles()
{
  // Return or file list:
...
///\remarks The recent file list is unchecked. Use the filenames with caution.
////////////////////////////////////////////////////////////////////////////////
const QStringList& DocumentManager::recentFiles() const
{
  // Return or file list:
  return m_recentFiles;
}
...
////////////////////////////////////////////////////////////////////////////////
///\brief Clears the current recent file list.
////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
// DocumentManager::emitRecentFilesChanged()
//////////////////////////////////////////////////////////////////////////////
///\brief Fire a recentFilesChanged event.
//////////////////////////////////////////////////////////////////////////////
void DocumentManager::emitRecentFilesChanged()
{
  // Emit the signal if not blocked:
  if (!signalsBlocked())
